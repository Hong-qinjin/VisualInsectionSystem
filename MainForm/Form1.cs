...
using VM.Core;
using VM.PlatformSDKCS;  namespace VisualInsectionSystem {     public partial class Form1 : Form     {                  public static Form1 form1 = null;   // 设置form1为主窗口                public static List<Form> subForms = new List<Form>();   // 子窗口集合
        ...
        public Form1()         {             InitializeComponent();             vmMainViewConfigControl1.Dock = DockStyle.Fill;             //设置form1为主窗口             form1 = this;             //初始化子窗口集合             //subForms.Add(new CameraForm());             //subForms.Add(new CommunicationForm());             subForms.Add(new DebugForm());             //subForms.Add(new AlarmForm());             //subForms.Add(new LogForm());             //subForms.Add(new UserForm());             //subForms.Add(new HelpForm());             //初始化菜单栏             //InitMenuStrip();             ////初始化工具栏             //InitToolBar();             ////初始化状态栏             //InitStatusBar();             ////初始化窗体             //InitForm();         }          private void Form1_Load_1(object sender, EventArgs e)         {
            //UI_Control加载
            try
            {
