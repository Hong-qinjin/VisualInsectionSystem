...
namespace ProcessControl
{
    public partial class Form1 : Form
    {
        ...
        /****************************************************************************
         * @fn           选择流程文件路径
         * @fn           Select the procedure file path
         ****************************************************************************/
        ...
        private void buttonImportProcess_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                m_VmPrc = VmProcedure.Load(textBoxProcessPath.Text);
            }
            catch (VmException ex)
            {
        ...
        private void buttonExportProcess_Click(object sender, EventArgs e)
        {
            ...
            if (m_VmPrc != null)
            {
                try
                {
                    ...
                    m_VmPrc.SaveAs(textBoxProcessPath.Text);
                }
                catch (VmException ex)
                {
