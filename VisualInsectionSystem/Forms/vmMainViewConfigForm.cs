...
{
    public partial class vmMainViewConfigForm : Form
    {
        public vmMainViewConfigForm()
        {
            InitializeComponent();
            //VM 资源管理1.5__2:00
            ...
            try
            {
                ...
                if (workStatusInfo.nWorkStatus == 0 && workStatusInfo.nProcessID == 10000)
                {
                    ...
                    this.BeginInvoke(new Action(() =>  //在回调中对控件操作，需要使用委托
                    {
                        ...
                        vmMainViewConfigControl1.BindMultiProcedure();
        ...
        private void vmMainViewConfigForm_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DialogResult openFileRes = openFileDialog.ShowDialog();     // 打开文件对话框
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //VmRenderControl vmMainViewConfigControl1 = new /*VMControls.Winform.Release.*/VmRenderControl();
                ...
                //vmMainViewConfigControl1.ModuleSource = vmProcedure;    //设置全局渲染控件的显示源与流程绑定
                //vmMainViewConfigControl1.ModuleSource = renderCtrlProcess;
                ...
                //vmMainViewConfigControl1.ModuleSource = imvsGroup;
                //vmMainViewConfigControl1.ModuleSource = renderCtrlGroup;
                ...
                vmMainViewConfigControl1.BindMultiProcedure();
                //vmMainViewConfigControl1.ModuleSource = imsvCct;
                //vmMainViewConfigControl1.ModuleSource = renderCtrlCircleTool;
