...
namespace VisualInsectionSystem
{
    public partial class MainForm : Form
    {
        ...
        private void InitUI()
        {
            ...
            vmRenderControl1.Dock = DockStyle.Fill;
        ...
        {
            vmRenderControl1.ModuleSource = m_VmProc; //绑定多流程
        }
        ...
        */
        ...
        {
            //vmRenderControl1.LockWorkArea();
            ////锁定参数配置页，不允许编辑流程 / Group / 模块的参数配置页
            //vmRenderControl1.SetParamTabEditable(false);
        ...
        {
            //vmRenderControl1.UnlockWorkArea();
            ////解锁参数配置页，允许编辑流程 / Group / 模块的参数配置页
            //vmRenderControl1.SetParamTabEditable(true);
        }
